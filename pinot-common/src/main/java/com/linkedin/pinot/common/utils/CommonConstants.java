...
public class CommonConstants {
  ...
  public static class Broker {
    ...
    public static final String CONFIG_OF_TABLE_SCHEMA_MAXIMUM_CACHE_SIZE = "pinot.broker.table.schema.cache.size";
    public static final int DEFAULT_TABLE_SCHEMA_CACHE_SIZE = 2000;
